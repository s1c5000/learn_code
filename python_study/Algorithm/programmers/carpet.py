...
vProdcutDataTabel = ["1번째상품" , "2번째상품", "3번째상품", "4번째상품", "5번째상품 : 최저가격", "6번째상품"]

for prodcut in range(len(vProdcutDataTabel)):

    if "최저" in vProdcutDataTabel[prodcut]:
        print("최저 있음")
        break

    if prodcut == len(vProdcutDataTabel)-1 and "최저" not in vProdcutDataTabel[prodcut]:
        print("낮은 가격순 클릭")
